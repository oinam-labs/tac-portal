...
test.describe('Manifest Workflow', () => {
    ...
    test('should view manifest details', async ({ page }) => {
        ...
        await expect(page.locator('h1, h2').filter({ hasText: /manifest/i })).toBeVisible({ timeout: 10000 });
    });
...
test.describe('Scanning Workflow', () => {
    ...
    test('should switch scan modes', async ({ page }) => {
        ...
        await expect(page.locator('h1, h2').filter({ hasText: /scan/i })).toBeVisible({ timeout: 10000 });
    });
