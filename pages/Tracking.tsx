      ...
      {result && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="lg:col-span-1 p-6">
            ...
            <h3 className="text-lg font-bold text-foreground mb-6">Shipment Journey</h3>
          ...
          <Card className="lg:col-span-2 relative overflow-hidden min-h-[400px] bg-background">
            ...
            <div className="absolute inset-0">
              <div className="absolute top-1/2 left-1/4 -translate-y-1/2 text-center">
                ...
                <span className="text-xs font-bold text-foreground bg-background/70 backdrop-blur-sm px-2 py-1 rounded">
