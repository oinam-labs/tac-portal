...
import { playSuccessFeedback, playErrorFeedback, playWarningFeedback, playInfoFeedback, playManifestActivatedFeedback, playManifestClosedFeedback } from '../lib/feedback';

type Section = 'buttons' | 'badges' | 'inputs' | 'cards' | 'skeletons' | 'feedback' | 'colors' | 'status';
...
const ButtonsSection: React.FC = () => (
    <div className="space-y-8">
        ...
        <Card>
            ...
            <ComponentGrid>
                <Button><Package className="w-4 h-4" /> Create Shipment</Button>
                <Button variant="secondary"><Truck className="w-4 h-4" /> Manifests</Button>
                <Button variant="danger"><AlertTriangle className="w-4 h-4" /> Exception</Button>
            </ComponentGrid>
        </Card>
    </div>
);
...
const StatusSection: React.FC = () => {
    const shipmentStatuses = [
        ...
        'IN_TRANSIT_TO_DESTINATION', 'RECEIVED_AT_DEST_HUB', 'OUT_FOR_DELIVERY',
        'DELIVERED', 'EXCEPTION_RAISED', 'CANCELLED'
    ];
