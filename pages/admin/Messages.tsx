...
import { Loader2, Mail, Archive, CheckCircle, Trash2, Eye, MessageCircle, ExternalLink } from 'lucide-react';
                                    ...
                                    >
                                        ...
                                        <TableCell>
                                            <div className="flex gap-2">
                                                ...
                                                {msg.replied && <Badge variant="outline" className="bg-green-50 text-green-700 border-green-200">Replied</Badge>}
                                        ...
                                        <TableCell className="text-right space-x-2" onClick={(e) => e.stopPropagation()}>
                                            ...
                                            >
                                                {msg.status === 'unread' ? <Mail className="h-4 w-4" /> : <CheckCircle className="h-4 w-4" />}
                                            </Button>
                                            <Button
                                                variant="ghost"
                                                size="icon"
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="space-y-1 text-right">
                                    ...
                                    <div className="flex justify-end gap-2">
                                        ...
                                        {selectedMessage.replied && <Badge variant="outline" className="bg-green-50 text-green-700 border-green-200">Replied</Badge>}
