    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Operations summary for shift handover</p>
        </div>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center gap-4 text-sm">
              ...
              <span className="font-medium">{format(new Date(report.shiftPeriod.end), 'PPp')}</span>
              <Badge variant="secondary">{report.shiftPeriod.durationHours} hours</Badge>
            </div>
          </CardContent>
        </Card>
      )}
