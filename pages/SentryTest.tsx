      ...
      <Card className="w-full max-w-md relative z-10 border-yellow-500/30 shadow-[0_0_50px_rgba(234,179,8,0.1)] p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Developer tools for error tracking verification
            </p>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <div className="border-b border-border/50 pb-2 mb-3">
            <h2 className="text-xs font-mono text-muted-foreground uppercase tracking-wide">
              Error Capture
            </h2>
          </div>
          ...
          <Button
            onClick={async () => {
              ...
              if (feedback) {
                ...
                alert(
                  'Feedback integration not found. Make sure Sentry is initialized with feedbackIntegration.'
                );
              }
            }}
            variant="default"
        ...
        <div className="mt-6 pt-4 border-t border-border text-center text-xs text-muted-foreground">
          <p className="font-mono">
            Route: <code className="text-primary">/dev/sentry</code>
          </p>
        </div>
      </Card>
    </div>
