    ...
    return (
        <Card className="flex flex-col h-full">
            ...
            <CardContent className="flex-1 pb-0">
                <div className="h-[250px] w-full relative">
                        ...
                        <PieChart>
                            ...
                            >
                                {statusChartData.map((_, index) => (
                                    <Cell key={`cell-${index}`} fill={STATUS_COLORS[index % STATUS_COLORS.length]} stroke={isDark ? '#0f172a' : '#ffffff'} strokeWidth={2} />
                                ))}
                            </Pie>
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                        <span className="text-3xl font-bold text-slate-900 dark:text-white font-mono">{totalShipments.toLocaleString()}</span>
            ...
            <CardFooter className="flex-col gap-2 text-sm">
                ...
                <div className="flex items-center gap-2 leading-none font-medium text-slate-900 dark:text-white mt-2">
