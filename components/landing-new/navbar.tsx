    ...
    return (
        <nav className="fixed top-0 z-50 w-full border-b border-border/40 bg-background/60 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60">
            <div className="container mx-auto flex h-20 max-w-7xl items-center justify-between px-6">
                ...
                <Link
                    to="/"
                    className="flex items-center gap-2.5 group mr-8 relative z-50"
                >
                            ...
                            <SheetContent side="right" className="w-[300px] border-l border-border bg-background/95 backdrop-blur-2xl p-0">
                                <div className="flex flex-col h-full">
                                    ...
                                    <div className="p-6 mt-auto">
                                        <Button className="w-full rounded-full h-12 text-base font-medium shadow-lg shadow-primary/20" onClick={() => window.location.href = '/login'}>
                                            Login
                                        </Button>
                                    </div>
                                </div>
