    ...
    return (
        <div ref={ref} className="p-8 bg-white text-black font-sans print-container">
            ...
            <div className="grid grid-cols-2 gap-8 mb-8 text-sm">
                ...
                <div className="border p-4">
                    <div className="font-bold text-xs uppercase text-muted-foreground mb-2">Transport Details</div>
                ...
                <tbody>
                    {items.map((item, index) => (
                        <tr key={item.id} className="border-b border-border">
                            ...
                            <td className="p-2 pl-4 italic text-muted-foreground">{item.shipment.special_instructions || '-'}</td>
                        </tr>
                    ))}
                </tbody>
                <tfoot>
