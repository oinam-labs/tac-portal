    ...
    return (
        <div className="flex flex-col gap-5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="flex flex-col gap-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(val) => form.setValue("fromHubId", val, { shouldValidate: true, shouldDirty: true, shouldTouch: true })}
                                >
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(val) => form.setValue("toHubId", val, { shouldValidate: true, shouldDirty: true, shouldTouch: true })}
                                >
                                    ...
                                    <SelectContent>
                                        {hubs.filter(h => h.id !== form.watch("fromHubId")).map((hub) => (
                                            <SelectItem key={hub.id} value={hub.id}>
                                                {hub.name} ({hub.code})
                                            </SelectItem>
                                        ))}
                ...
                <Card className="border-border bg-card/50 xl:col-span-5">
                    ...
                    <CardContent>
                        <ToggleGroup
                            ...
                            value={transportType}
                            onValueChange={(value) => {
                                if (value) form.setValue("type", value as "AIR" | "TRUCK", { shouldValidate: true, shouldDirty: true, shouldTouch: true })
                            }}
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
                                        ...
                                        <PopoverTrigger asChild>
                                            ...
                                            >
                                                ...
                                                <span className="truncate">
                                                    {form.watch("dispatchDate") ? format(form.watch("dispatchDate")!, 'MMM d, yyyy') : 'Pick a date'}
                                                </span>
                                            </Button>
                                        </PopoverTrigger>
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="flex gap-2">
                                        <Select
                                            ...
                                            onValueChange={(v) => form.setValue("dispatchHour", v, { shouldDirty: true, shouldTouch: true })}
                                        >
                                        ...
                                        <Select
                                            ...
                                            onValueChange={(v) => form.setValue("dispatchMinute", v, { shouldDirty: true, shouldTouch: true })}
                                        >
                                            <SelectTrigger className="flex-1">
                                        ...
                                        <Select
                                            ...
                                            onValueChange={(v) => form.setValue("dispatchPeriod", v as "AM" | "PM", { shouldDirty: true, shouldTouch: true })}
                                        >
                                            <SelectTrigger className="flex-1">
                ...
                {/* Transport Details */}
                <Card className={cn("border-border bg-card/50", transportType === 'AIR' ? 'xl:col-span-2' : '')}>
                    <CardHeader className="pb-4">
                        <CardTitle className="text-base font-semibold">
                            {transportType === 'AIR' ? 'Flight Details' : 'Vehicle Details'}
                        </CardTitle>
                        <CardDescription>
                            {transportType === 'AIR' ? 'Enter airline and flight information' : 'Enter vehicle and driver information'}
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="flex flex-col gap-4">
                        {transportType === 'AIR' ? (
                                        ...
                                        <Popover>
                                            <PopoverTrigger asChild>
                                                ...
                                                >
                                                    <CalendarIcon className="mr-2 h-4 w-4 shrink-0" />
                                                    <span className="truncate">
                                                        {form.watch("flightDate") ? format(form.watch("flightDate")!, 'MMM d, yyyy') : 'Pick a date'}
                                                    </span>
                                                </Button>
                                            </PopoverTrigger>
                                            <PopoverContent className="w-auto p-0" align="start">
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <div className="flex gap-2">
                                            <Select
                                                ...
                                                onValueChange={(v) => form.setValue("etdHour", v, { shouldDirty: true, shouldTouch: true })}
                                            >
                                                <SelectTrigger className="flex-1">
                                                    <SelectValue placeholder="HH" />
                                                </SelectTrigger>
                                            ...
                                            <Select
                                                ...
                                                onValueChange={(v) => form.setValue("etdMinute", v, { shouldDirty: true, shouldTouch: true })}
                                            >
                                                <SelectTrigger className="flex-1">
                                                    <SelectValue placeholder="MM" />
                                                </SelectTrigger>
                                            ...
                                            <Select
                                                ...
                                                onValueChange={(v) => form.setValue("etdPeriod", v as "AM" | "PM", { shouldDirty: true, shouldTouch: true })}
                                            >
                                                <SelectTrigger className="flex-1">
                                                    <SelectValue placeholder="AM" />
                                                </SelectTrigger>
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <div className="flex gap-2">
                                            <Select
                                                ...
                                                onValueChange={(v) => form.setValue("etaHour", v, { shouldDirty: true, shouldTouch: true })}
                                            >
                                                <SelectTrigger className="flex-1">
                                                    <SelectValue placeholder="HH" />
                                                </SelectTrigger>
                                            ...
                                            <Select
                                                ...
                                                onValueChange={(v) => form.setValue("etaMinute", v, { shouldDirty: true, shouldTouch: true })}
                                            >
                                                <SelectTrigger className="flex-1">
                                                    <SelectValue placeholder="MM" />
                                                </SelectTrigger>
                                            ...
                                            <Select
                                                ...
                                                onValueChange={(v) => form.setValue("etaPeriod", v as "AM" | "PM", { shouldDirty: true, shouldTouch: true })}
                                            >
                                                <SelectTrigger className="flex-1">
                                                    <SelectValue placeholder="AM" />
                                                </SelectTrigger>
                            ...
                            <>
                                <div className="flex flex-col gap-2">
                                    ...
                                    <Input
                                        ...
                                        className={cn("uppercase font-mono", form.formState.errors.vehicleNumber && "border-destructive")}
                                    />
