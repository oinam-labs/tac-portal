...
export function StepReviewFinalize({ setupData, shipments, hubs }: StepReviewFinalizeProps) {
    ...
    const totalPieces = validShipments.reduce((sum, s) => sum + (s.package_count || s.total_packages || 0), 0)
                        ...
                        {setupData.type === 'AIR' ? (
                            ...
                            <>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium">
                                            {formatTime(setupData.dispatchHour, setupData.dispatchMinute, setupData.dispatchPeriod)}
                                        </p>
                    ...
                    {setupData.type === 'AIR' ? (
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-medium">{formatTime(setupData.etdHour, setupData.etdMinute, setupData.etdPeriod)}</p>
                                    <p className="text-xs text-muted-foreground">ETD</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-medium">{formatTime(setupData.etaHour, setupData.etaMinute, setupData.etaPeriod)}</p>
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                            Review all details above. Click &quot;Create Manifest&quot; to save as OPEN, or &quot;Close Manifest&quot; to finalize immediately.
                        </p>
                    </div>
                </div>
            </div>
