...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside
      className={`fixed left-0 top-0 h-full bg-cyber-surface/95 border-r border-cyber-border backdrop-blur-xl transition-all duration-300 z-50 flex flex-col ${sidebarCollapsed ? 'w-20' : 'w-64'}`}
    >
      {/* Logo Area */}
