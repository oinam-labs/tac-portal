...
const badgeVariants = cva(
  'inline-flex items-center border px-2 py-0.5 text-xs font-semibold font-mono uppercase tracking-wide transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
