            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="mb-20 max-w-2xl">
                    ...
                    <p className="text-lg text-muted-foreground/80 leading-relaxed font-light">
                        Our protocol optimizes every millisecond of the logistics chain.
                    ...
                    {[
                        ...
                        >
                            ...
                            <h3 className="font-mono text-xl font-bold tracking-tight text-foreground mb-3 flex items-center gap-2">
                                {item.title}
                                <span className="opacity-0 group-hover:opacity-100 transition-opacity text-primary text-xs">&rarr;</span>
                            </h3>
