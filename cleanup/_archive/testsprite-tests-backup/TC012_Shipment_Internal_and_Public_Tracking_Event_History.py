...
async def run_test():
    ...
    try:
        ...
        await page.wait_for_selector('[data-testid="new-shipment-button"] to fetch shipment event history
        await page.wait_for_selector('[data-testid="new-shipment-button"]')
        await page.wait_for_timeout(3000); await elem.click(timeout=15000)
        ...
        await page.wait_for_selector('[data-testid="new-shipment-button"] to see if it triggers any change or reveals input fields
        await page.wait_for_selector('[data-testid="new-shipment-button"]')
        await page.wait_for_timeout(3000); await elem.click(timeout=15000)
        ...
        # --> Assertions to verify final state
                try:
            await expect(page.locator('text=Unauthorized Shipment Data Access')).to_be_visible(timeout=1000)
