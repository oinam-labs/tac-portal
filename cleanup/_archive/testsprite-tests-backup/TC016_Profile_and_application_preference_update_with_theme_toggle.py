...
async def run_test():
    ...
    try:
        ...
        await page.wait_for_selector('xpath=html/body/div')
        await page.wait_for_timeout(3000); await elem.click(timeout=15000)
        ...
        await page.wait_for_selector('[data-testid="dashboard-page"]/div/main/div/div[2]/div/div[2]/div/input')
        await page.wait_for_timeout(3000); await elem.fill('TAC-New York')
        

                # Update Timezone to America/New_York
        await page.wait_for_selector('[data-testid="new-shipment-button"] to change theme
        await page.wait_for_selector('[data-testid="new-shipment-button"]')
        await page.wait_for_timeout(3000); await elem.click(timeout=15000)
        ...
        await page.wait_for_selector('[data-testid="new-shipment-button"]/div/span/img')
        await page.wait_for_timeout(3000); await elem.click(timeout=15000)
        ...
        await page.wait_for_selector('xpath=html/body/div[2]/div')
        await page.wait_for_timeout(3000); await elem.click(timeout=15000)
        ...
        await page.wait_for_selector('xpath=html/body/div[2]/div/div[5]')
        await page.wait_for_timeout(3000); await elem.click(timeout=15000)
