...
async def run_test():
    ...
    try:
        ...
        await page.wait_for_selector('[data-testid="new-shipment-button"] on the first shipment to open details and prepare for status update.
        await page.wait_for_selector('[data-testid="new-shipment-button"]')
        await page.wait_for_timeout(3000); await elem.click(timeout=15000)
        ...
        # --> Assertions to verify final state
                try:
            await expect(page.locator('text=Real-time subscription active')).to_be_visible(timeout=1000)
