...
async def run_test():
    ...
    try:
        ...
        await page.wait_for_selector('nav"Test plan execution failed: UI components do not meet design standards for loading, empty, and error states; keyboard navigation, color contrast, or screen reader accessibility.")
