...
async def run_test():
    ...
    try:
        ...
        # -> Try to input password again or use keyboard input method or try clicking password field before input.
                # Click password field to focus before input
        ...
        # -> Click the Sign In button to submit the login form and proceed to dashboard.
        ...
        # --> Assertions to verify final state
                try:
            await expect(page.locator('text=Unauthorized Data Exposure Detected')).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test case failed: Dashboard KPIs and charts do not reflect real-time data updates filtered according to the user's role and organization, indicating possible unauthorized data exposure or failure in real-time updates.")
