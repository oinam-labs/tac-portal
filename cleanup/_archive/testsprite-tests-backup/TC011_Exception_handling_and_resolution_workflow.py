...
async def run_test():
    ...
    try:
        ...
        await page.wait_for_selector('[data-testid="new-shipment-button"] for the first shipment TAC20260005 to open shipment details for exception creation
        ...
        # --> Assertions to verify final state
                try:
            await expect(page.locator('text=Shipment Exception Successfully Resolved')).to_be_visible(timeout=1000)
