...
async def run_test():
    ...
    try:
        ...
        await page.wait_for_selector('[data-testid="new-shipment-button"] to assign the scanned barcode to a manifest
        await page.wait_for_selector('[data-testid="new-shipment-button"]')
        await page.wait_for_timeout(3000); await elem.click(timeout=15000)
        ...
        # --> Assertions to verify final state
                try:
            await expect(page.locator('text=Duplicate barcode scan detected')).to_be_visible(timeout=1000)
