...
async def run_test():
    ...
    try:
        ...
        await page.wait_for_selector('[data-testid="dashboard-page"]/aside/nav/div[2]/div[2]/a[5]')
        await page.wait_for_timeout(3000); await elem.click(timeout=15000)
        ...
        await page.wait_for_selector('[data-testid="new-shipment-button"] on a shipment likely outside user's org/hub scope (e.g., AWB TAC20260010 or TAC20260009 with route DEL→IMF) to verify access restrictions.
