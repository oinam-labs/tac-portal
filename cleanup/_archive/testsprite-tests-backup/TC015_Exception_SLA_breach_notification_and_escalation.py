...
async def run_test():
    ...
    try:
        ...
        await page.wait_for_selector('nav"login-email-input"]')
        ...
        await page.wait_for_selector('[data-testid="new-shipment-button"] to submit the new exception
        await page.wait_for_selector('[data-testid="new-shipment-button"]')
        await page.wait_for_timeout(3000); await elem.click(timeout=15000)
        ...
        # --> Assertions to verify final state
                try:
            await expect(page.locator('text=Exception SLA Met Successfully')).to_be_visible(timeout=1000)
