...
async def run_test():
    ...
    try:
        ...
        await page.wait_for_selector('[data-testid="new-shipment-button"] to ensure form is active
        await page.wait_for_selector('[data-testid="new-shipment-button"][2]')
        await page.wait_for_timeout(3000); await elem.click(timeout=15000)
        ...
        await page.wait_for_selector('[data-testid="new-shipment-button"] to open shipment creation form again.
        ...
        # --> Assertions to verify final state
                try:
            await expect(page.locator('text=Invalid Status Transition Detected')).to_be_visible(timeout=1000)
