...
async def run_test():
    ...
    try:
        ...
        # --> Assertions to verify final state
                try:
            await expect(page.locator('text=Shipment Completed Successfully')).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test case failed: Shipment lifecycle status transitions validation failed as per business rules, or audit logging did not capture required details.")
