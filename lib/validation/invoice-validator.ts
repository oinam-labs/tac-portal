...
export function validateGSTIN(gstin: string | undefined | null): ValidationResult {
    ...
    if (!gstin) {
        ...
        return { isValid: true, errors, warnings: ['GSTIN not provided - GST invoice cannot be generated'] };
    }
...
export function validateInvoice(
    ...
    if (!invoice.customerId) {
        allErrors.push({ field: 'customerId', message: 'Customer is required', code: 'CUSTOMER_REQUIRED' });
    }
