    ...
    Tables: {
      ...
      shipments: {
        Row: {
          ...
          status: 'CREATED' | 'RECEIVED' | 'LOADED_FOR_LINEHAUL' | 'IN_TRANSIT' | 'RECEIVED_AT_DEST' | 'OUT_FOR_DELIVERY' | 'DELIVERED' | 'EXCEPTION' | 'CANCELLED'
      ...
      exceptions: {
        Row: {
          ...
          org_id: string
          shipment_id: string
          type: 'DAMAGED' | 'LOST' | 'DELAYED' | 'MISMATCH' | 'PAYMENT_HOLD' | 'MISROUTE' | 'ADDRESS_ISSUE'
