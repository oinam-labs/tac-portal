...
async def run_test():
    ...
    try:
        ...
        elem = frame.locator('xpath=html/body/div[4]/div[3]/div/div/div/div/div[2]/div/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        # -> Report the website issue due to inability to proceed with manifest creation and stop further testing.
        frame = context.pages[-1]
